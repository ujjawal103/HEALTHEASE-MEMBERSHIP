    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <h1 className="text-3xl md:text-5xl font-extrabold mb-6">About HealthEase Membership</h1>
          <p className="opacity-80 leading-relaxed">
            HealthEase Membership began with a commitment to support families who struggle with rising medical costs.
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            <div className="p-6 rounded-2xl bg-gray-50">
              ...
              <p className="text-sm opacity-80">Launched in UTTAR PRADESH, built ground-up with local partners and health advisors.</p>
            </div>
            <div className="p-6 rounded-2xl bg-gray-50">
